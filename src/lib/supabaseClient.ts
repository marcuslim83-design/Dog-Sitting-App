...
const rawUrl = import.meta.env.VITE_SUPABASE_URL || 'https://gwyfdkcaklvxdhuokdel.supabase.co';
const rawAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd3eWZka2Nha2x2eGRodW9rZGVsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzk0MTE1ODcsImV4cCI6MjA5NDk4NzU4N30.3p7O3PCC97fm82LfO_uW1Yjafuw5lcZQRFMR7G19R00';
